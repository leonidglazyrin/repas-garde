...
export interface Member { id: string; household_id: string; name: string; role: Role; created_at?: string; profile_color?: string; restrictions?: string; dislikes?: string; favorites?: string; normal_foods?: string; }
