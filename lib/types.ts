...
export interface Member {
  id: string; household_id: string; name: string; role: Role; created_at?: string;
  profile_color?: string; restrictions?: string;
}
...
export interface Meal {
  id: string; week_id: string; day_index: number; meal_type: MealType; title: string;
  description: string; ingredients: string[]; notes: string; profile_ids?: string[];
...
export const APPROVAL_META: Record<ApprovalStatus, { label: string; color: string; soft: string; icon: string }> = {
